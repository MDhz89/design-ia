...
- Important business rules, permissions, and state transitions.
- Differentiators that can be demonstrated or verified.
...
## 4. Build in focused stages

Recommended order:

1. Page structure and navigation.
2. Hero and first product demonstration.
3. Problem narrative.
4. Core workflow.
